...
{
    public class ArmorPiercingBulletSkill : Skill
    {
        private readonly ModifyAttributeEffectFactory _effectFactory;
        private IModifyAttributeEffect _currentEffect;

        public ArmorPiercingBulletSkill(GameData.Skill skillData, TextStore textStore,
        ...
        private void ApplyEffect()
        {
            ...
            // "ARMOR_PIERCING_BULLET" 효과 ID를 사용
            _currentEffect = _effectFactory.Create("ARMOR_PIERCING_BULLET", GetLevel());
            if (_currentEffect != null)
            {
