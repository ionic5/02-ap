...
{
    public class TacticalBackpackSkill : Skill
    {
        private readonly ModifyAttributeEffectFactory _effectFactory;
        private IModifyAttributeEffect _currentEffect;

        public TacticalBackpackSkill(GameData.Skill skillData, TextStore textStore,
        ...
        private void ApplyEffect()
        {
            ...
            // "TACTICAL_BACKPACK" 효과 ID를 사용
            _currentEffect = _effectFactory.Create("TACTICAL_BACKPACK", GetLevel());
            if (_currentEffect != null)
            {
